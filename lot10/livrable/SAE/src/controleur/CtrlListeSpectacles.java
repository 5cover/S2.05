...
public class CtrlListeSpectacles {
    ...
    @FXML
    private TableView<Spectacle> tvListeSpectacle = new TableView<>();
    ...
    void initialize() {
        ...
        txt_nomSpectacle.textProperty().bind(Bindings.createStringBinding(() -> {
